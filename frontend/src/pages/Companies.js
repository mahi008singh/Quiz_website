...
const Companies = () => {
    ...
    const {setKeyTopic,isCompany,setIsCompany } = useContext(QuizContext)
    
  return (
    
    <section className='subjects'>
         <h1 style={{fontSize:"2rem"}}>Welcome, {JSON.parse(localStorage.getItem("userName"))} !!</h1>
